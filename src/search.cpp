...
int t[] = {22661, 26237, 4506, 5337, 4341, 16384, 14382};
TUNE(t);
    ...
    while ((move = mp.next_move(moveCountPruning)) != MOVE_NONE)
    {
          ...
          else
          {
              ...
              if (   lmrDepth < 7
                  ...
                  &&  (*contHist[0])[movedPiece][to_sq(move)]
                    ...
                    + (*contHist[5])[movedPiece][to_sq(move)] / 3 < t[1])
                  continue;
      ...
      if (    depth >= 3
          ...
          && (  !captureOrPromotion
              ...
              || cutNode
              || (!PvNode && !formerPv && captureHistory[movedPiece][to_sq(move)][type_of(pos.captured_piece())] < t[2])
          ...
          else
          {
              ...
              if (ss->inCheck)
                  r -= (thisThread->mainHistory[us][from_to(move)]
                     + (*contHist[0])[movedPiece][to_sq(move)] - t[4]) / t[5];
              else
                  r -= ss->statScore / t[6];
          }
