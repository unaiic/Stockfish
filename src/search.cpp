    ...
    while ((move = mp.next_move(moveCountPruning)) != MOVE_NONE)
    {
          ...
          else
          {
              ...
              if (   lmrDepth < 7
                  ...
                  &&  (*contHist[0])[movedPiece][to_sq(move)]
                    ...
                    + (*contHist[5])[movedPiece][to_sq(move)] / 3 < 27529)
                  continue;
      ...
      if (    depth >= 3
          ...
          && (  !captureOrPromotion
              ...
              || cutNode
              || (!PvNode && !formerPv && captureHistory[movedPiece][to_sq(move)][type_of(pos.captured_piece())] < 4359)
          ...
          else
          {
              ...
              if (ss->inCheck)
                  r -= (thisThread->mainHistory[us][from_to(move)]
                     + (*contHist[0])[movedPiece][to_sq(move)] - 2981) / 17937;
              else
                  r -= ss->statScore / 14555;
          }
